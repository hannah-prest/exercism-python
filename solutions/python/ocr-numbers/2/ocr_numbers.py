...
def convert(input_grid):
    ...
    def parse_cell(matrix):
        ...
        top      = matrix[0][1] == "_"  # top row, middle char
        middle   = matrix[1][1] == "_"  # middle row, middle char
        bottom   = matrix[2][1] == "_"  # bottom row, middle char
        top_left  = matrix[1][0] == "|"  # middle row, left char
        top_right = matrix[1][2] == "|"  # middle row, right char
        bot_left  = matrix[2][0] == "|"  # bottom row, left char
        bot_right = matrix[2][2] == "|"  # bottom row, right char
